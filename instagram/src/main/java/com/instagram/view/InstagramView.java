...
String cc="y";
	...
	System.out.println("press 8 to view userDetailwithhistory");
	...
	//if console db is open earlier or cmd is open ,it will show error ..unable to load database.
